...
public class IngredienteModalController {
 ...
 private static final String TITULO_EDITAR = " Editar Ingrediente";
 ...
 try (Connection conn = dbConnection.getConnection();
 PreparedStatement stmt = conn.prepareStatement("UPDATE ingredientes SET estado = 'Inactivo' WHERE id_ingrediente = ?")) {
