...
public class EntregasController {
    ...
    private void generarFactura(EntregaHistorial entrega) {
        try {
            ...
            params.put("idPedido", entrega.getId());
            net.sf.jasperreports.engine.JasperReport report = rs.compileReport("/reportes/FacturaPedido.jrxml");
            ...
            mostrarMensaje("Error", "No se pudo generar la factura: " + e.getMessage());
        }
    }
